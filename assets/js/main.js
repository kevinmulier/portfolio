...
(function ($) {
  ...
  // Mode sombre
  const darkModeToggler = document.querySelector("#darkModeToggle");
  const bodyDark = document.querySelector("body");

  // Remplace l'icon selon le mode utilisé
  if (bodyDark.classList.contains("darkMode")) {
    darkModeToggler.classList.add("fa-sun");
    darkModeToggler.classList.remove("fa-moon");
  } else {
    darkModeToggler.classList.remove("fa-sun");
    darkModeToggler.classList.add("fa-moon");
  }
  //  Ajoute l'évènement de click
  darkModeToggler.addEventListener("click", toggleDarkMode);

  //   Fonction toggle darkMode
  ...
  // Vérifie si l'utilisateur a activé le mode sombre sur sa dernière session
